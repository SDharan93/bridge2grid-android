...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton wikipedia, finance, weather, news;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wikipedia = (ImageButton) findViewById(R.id.wikipediaButton);
        finance = (ImageButton) findViewById(R.id.financeButton);
